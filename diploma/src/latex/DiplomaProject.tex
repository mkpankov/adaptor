...
% Изменение форматов заголовков
\usepackage{titlesec}
\titleformat{\paragraph}[runin]
    {\normalfont\bfseries}
    {\S\ \theparagraph.}{2cm}{}[.]
\titlespacing{\paragraph}
    {\parindent}{1.5ex plus .1ex minus .2ex}{14pt}
% Изменение формата подрисуночной надписи
\usepackage{savesym}
\savesymbol{l@addto@macro}
% Выравнивание заголовков рисунков по центру
\RequirePackage[justification=centering]{caption}
\DeclareCaptionLabelFormat{plain}{Рисунок #2}
\captionsetup{labelformat=plain,labelsep=endash}
\restoresymbol{CAPTION}{l@addto@macro}
...
\input{DiplomaProject-Introduction}
\pagebreak
% Основная часть
% Теоретическая часть
\input{DiplomaProject-Theory}
\pagebreak
% Конструкторская часть
\input{DiplomaProject-Adaptor}
\pagebreak
% Исследование эффективности
\input{DiplomaProject-Evaluation}
\pagebreak
% Экономика
\input{DiplomaProject-Economics}
\pagebreak
% Охрана труда и экология
\input{DiplomaProject-Ecology}
% Название библиографии
\renewcommand\bibname{Список использованных источников}
% Список использованных источников
\bibliography{biblio/diploma}
% Приложение
\input{DiplomaProject-Appendix}
\end{document}
