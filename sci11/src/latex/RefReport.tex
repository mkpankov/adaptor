...
\begin{document}
% Титульный лист
\input{RefReport-Title}
% Сброс номера страницы
\setcounter{page}{2}
% Введение
\input{RefReport-Introduction}
% Валидация трансляции
\input{RefReport-TranslationValidation}
% Список использованных источников
\clearpage
% Удалён стандатный заголовок и вставлен вручную заголовок нужного типа
{\def\chapter*#1{}
